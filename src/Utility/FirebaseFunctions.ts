...
import { getFirestore, doc, setDoc, getDoc, serverTimestamp, addDoc, collection, orderBy, query, limit, getDocs } from "firebase/firestore";
...
export const getUserFromDB = async (uId: string): Promise<DBUser | undefined> => {
...
export const signOutUser = () => {
 ...
 export const createTweet = (user: DBUser ,tweetContent: string): TweetInfo => {
    let newTweet = {
      ...user,
